...
void CRect2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CRect2Doc::InitializeSearchContent()
{
...
void CRect2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
